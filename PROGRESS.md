...
before it, and never quoted from the header it replaces:** **758 lines and 118,294 bytes**, which is
**42 lines and 12,778 bytes under the hard bounds** (800 lines / 131,072 bytes) and far over both
