...
before it, and never quoted from the header it replaces:** **686 lines and 122,760 bytes**,
which is **114 lines and 8,312 bytes under the hard bounds** (800 / 131,072) and over both soft
