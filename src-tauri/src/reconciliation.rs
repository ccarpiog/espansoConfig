...
/// [`espansoconfig_core::watch::retained_state`]'s clause 5, **a rule that does
/// not know this assertion exists**: the offending entry goes when that rule
/// happens to name it, never because it is the entry that trips here; and
